...
-asn1_info([{vsn,'5.0.21.1'},
 ...
 {cwd,"/home/tonpa/depot/synrc/chat/priv/v2"},
 {outdir,"/home/tonpa/depot/synrc/chat/priv/v2"},
 {i,"."},
 {i,"/home/tonpa/depot/synrc/chat/priv/v2"}]}]).
...
%%-------------------------------------------------
%% attribute session(2) with type OCTET STRING
%%-------------------------------------------------
   {EncBytes2,EncLen2} = encode_restricted_string(Cindex2, [<<4>>]),
...
%%-------------------------------------------------
   {EncBytes3,EncLen3} = 'enc_Person_names'(Cindex3, [<<48>>]),
...
%%-------------------------------------------------
   {EncBytes5,EncLen5} = 'enc_Person_surnames'(Cindex5, [<<48>>]),

%%-------------------------------------------------
%% attribute lastmsg(6)   External CHAT-v2:Message
%%-------------------------------------------------
...
%%-------------------------------------------------
   {EncBytes10,EncLen10} = 'enc_Person_settings'(Cindex10, [<<48>>]),
...
%%-------------------------------------------------
[V5|Tlv6] = Tlv5, 
Term5 = 'dec_Person_surnames'(V5, [16]),
...
%%-------------------------------------------------
[V10|Tlv11] = Tlv10, 
Term10 = 'dec_Person_settings'(V10, [16]),
...
Res1 = {'Person',Term1,Term2,Term3,Term4,Term5,Term6,Term7,Term8,Term9,Term10,Term11},
Res1.
...
%%-------------------------------------------------
%% attribute feed(2)   External CHAT-v2:MessageFeed
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute presence(11) with type ENUMERATED
%%-------------------------------------------------
   {EncBytes11,EncLen11} = case Cindex11 of
offline -> encode_tags([<<10>>], [1], 1);
online -> encode_tags([<<10>>], [2], 1);
...
Res1 = {'Member',Term1,Term2,Term3,Term4,Term5,Term6,Term7,Term8,Term9,Term10,Term11,Term12},
Res1.
