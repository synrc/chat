...
#   2984, 2876, 2785, 2630, 2631, 2632, 2633, 5083, 5084, 2634.
    ...
    def testDecryptECC(), do: CMS.decrypt(testECC(), testPrivateKeyECC())
    def testDecryptKEK(), do: CMS.decrypt(testKEK(), testPrivateKeyKEK())
    def testDecryptRSA(), do: CMS.decrypt(testRSA(), testPrivateKeyRSA())
    def test(),           do:
       [
          testDecryptECC(),
          testDecryptKEK(),
