...
- це основна refinement-модель kernel для інваріантів і typed semantics;
- його слід читати як глибше ядро порівняно з DSL-SEMANTIC-KERNEL;
- саме тут типи починають нести головні semantic constraints системи.
